...
[**↓ 下载 Popskill（2.8 MB，已签名 + 已公证）**](https://github.com/maojiebc/majia-Popskill/releases/latest/download/Popskill-2.17.0.dmg)
...
当前 [v2.17.0](https://github.com/maojiebc/majia-Popskill/releases/tag/v2.17.0) · 全部版本见 [Releases](https://github.com/maojiebc/majia-Popskill/releases) · 更新日志在 `docs/release/`
