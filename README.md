...
<table>
<tr>
<td width="50%"><img src="docs/screenshots/inspector.jpg" alt="整页详情 Inspector"></td>
<td width="50%"><img src="docs/screenshots/create.jpg" alt="新建能力"></td>
</tr>
<tr>
<td><b>整页详情 Inspector</b> — 点开任意能力,看 Claude/Codex 覆盖、组件清单、来源 / SSOT / 版本 / 本机用量</td>
<td><b>新建能力</b> — 编辑器 + 实时矩阵预览 + 安装目标开关 + 「将写入」终端预览</td>
</tr>
<tr>
<td width="50%"><img src="docs/screenshots/compose.jpg" alt="组装套装"></td>
<td width="50%"><img src="docs/screenshots/settings.jpg" alt="设置"></td>
</tr>
<tr>
<td><b>组装套装</b> — 勾选已有能力 → 实时覆盖统计 + 生成 popskill.toml</td>
<td><b>设置</b> — 连接 / 同步 / 源 / 安装 / 配额 / 关于 分页,工具连接 + 源管理</td>
</tr>
</table>
