...
[**↓ 下载 Popskill（2.2 MB，已签名 + 已公证）**](https://github.com/maojiebc/majia-Popskill/releases/latest/download/Popskill-2.1.1.dmg)
...
<tr>
<td><b>来源自动识别</b> — 四级回填（lock 文件 / git remote / frontmatter），装过的东西不用告诉它从哪来</td>
...
**Q：它会动我的文件吗？**
防呆三条铁律：只删 symlink、真实目录一律进回收站（`~/.agents/.trash/`，留 20 份）、store 目录绝不被开关动到。30 个引擎单测盯着这些行为。
...
当前 [v2.1.1](https://github.com/maojiebc/majia-Popskill/releases/tag/v2.1.1) · 全部版本见 [Releases](https://github.com/maojiebc/majia-Popskill/releases) · 更新日志在 `docs/release/`
