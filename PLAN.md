...
- **已完成**：本地 CI、read-only smoke、mutating repo smoke、`.app` development bundle、bundle launch smoke、development DMG 打包、release manifest/appcast 生成
...
- ✅ `scripts/dev-build.sh`、`scripts/ci-local.sh`、read-only smoke、mutating smoke、bundle smoke、development DMG 打包、release manifest/appcast 已落地
