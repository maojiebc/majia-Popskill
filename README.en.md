...
[**↓ Download Popskill (2.5 MB, signed + notarized)**](https://github.com/maojiebc/majia-Popskill/releases/latest/download/Popskill-2.13.2.dmg)
...
Current: [v2.13.2](https://github.com/maojiebc/majia-Popskill/releases/tag/v2.13.2) · all versions on [Releases](https://github.com/maojiebc/majia-Popskill/releases) · changelogs in `docs/release/`
