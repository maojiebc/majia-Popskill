...
[**↓ Download Popskill (2.8 MB, signed + notarized)**](https://github.com/maojiebc/majia-Popskill/releases/latest/download/Popskill-2.18.0.dmg)
...
Current: [v2.18.0](https://github.com/maojiebc/majia-Popskill/releases/tag/v2.18.0) · all versions on [Releases](https://github.com/maojiebc/majia-Popskill/releases) · changelogs in `docs/release/`
