...
[**↓ Download Popskill (2.3 MB, signed + notarized)**](https://github.com/maojiebc/majia-Popskill/releases/latest/download/Popskill-2.7.1.dmg)
...
Current: [v2.7.1](https://github.com/maojiebc/majia-Popskill/releases/tag/v2.7.1) · all versions on [Releases](https://github.com/maojiebc/majia-Popskill/releases) · changelogs in `docs/release/`
