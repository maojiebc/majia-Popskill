...
# 基线：126 个测试（StoreFSTests + AppModelTests + SchedTests + StoreWatchTests）+ 真实环境只读冒烟 POPSKILL_REAL_SMOKE=1（v2.16 起带链接状态分布，验 linkStatus 零误判）
```
